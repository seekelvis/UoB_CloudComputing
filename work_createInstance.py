...
[default]
aws_access_key_id=ASIASAB3CUXFY67UVMXA
aws_secret_access_key=QIM76YldNJ2TJx6EG8F+Q70ywTWDKh8siDJJx20W
aws_session_token=
EOF
"""
user_data2 = """#!/bin/bash
touch /home/ubuntu/t1.txt
...
cd /root
mkdir .aws
cp /home/ubuntu/UoB_CloudComputing/credentials /root/.aws/credentials
cp /home/ubuntu/UoB_CloudComputing/config /root/.aws/config
...
sudo python /home/ubuntu/UoB_CloudComputing/CNDinInstance.py
touch end.txt
"""
user_data4 = """#!/bin/bash
touch /home/ubuntu/begin.txt
...
[default]
aws_access_key_id=ASIASAB3CUXFZZLJHL77
aws_secret_access_key=G9MjfywOJJTKJHrzyaS/SfeRedIatc7G1R/Cbqt7
aws_session_token=
EOF
